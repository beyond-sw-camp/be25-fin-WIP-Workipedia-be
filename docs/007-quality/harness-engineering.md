...
> 문서 유형: Quality Guide
> 상태: Draft
> 정본 위치: `docs/007-quality/harness-engineering.md`
...
| Always a Knowledge Loop | 처리 완료 티켓은 지식화 후보 등록/검수 흐름을 가진다 | 워크플로우 테스트 |
...
| WF-008 | 지식화 후보 | 처리 완료 티켓은 개인 정보를 제거한 지식화 후보로 등록될 수 있다 |
...
- `docs/001-reference/constitution.md`를 기준 원칙 문서로 사용한다.
...
- 티켓 처리 완료 흐름이면 지식화 후보 등록/검수 검증이 있다.
