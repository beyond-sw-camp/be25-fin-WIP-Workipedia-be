...
> 문서 유형: ADR
> 상태: Draft
> 정본 위치: `docs/adr/0002-rag-strategy.md`
> 관련 문서: `docs/reference/constitution.md`, `docs/reference/trd.md`, `docs/quality/harness-engineering.md`
> 버전: v0.1
> 최종 수정: 2026-05-28
...
| 실패 처리 | no-answer + 워키/티켓 전환 | confidence calibration 고도화 |
