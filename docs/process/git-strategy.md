...
> 문서 유형: Process Guide
> 상태: Draft
> 정본 위치: `docs/process/git-strategy.md`
> 관련 문서: `docs/planning/wbs.md`, `docs/api/api-contract.md`, `docs/database/db-migration-guide.md`
> 버전: v0.1
> 최종 수정: 2026-05-28
...
- API 변경이 있으면 `docs/api/api-contract.md`를 갱신한다.
- DB 변경이 있으면 migration과 `docs/database/db-migration-guide.md`를 확인한다.
...
- API path나 request/response가 바뀌면 `docs/api/api-contract.md`를 먼저 수정한다.
- 테이블/컬럼이 바뀌면 `docs/database/db-migration-guide.md`와 migration 파일을 같이 수정한다.
