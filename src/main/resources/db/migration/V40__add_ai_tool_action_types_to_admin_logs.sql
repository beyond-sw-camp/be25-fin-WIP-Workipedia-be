-- admin_logs action_type CHECK 제약에 AI Tool 액션 타입 추가
-- AdminAiToolService.create()/update()가 AI_TOOL_CREATE, AI_TOOL_UPDATE 로그를 저장하지만
-- 기존 제약(V12)에 해당 값이 없어 AI Tool 등록/수정 시 CHECK 제약 위반으로 500이 발생함
