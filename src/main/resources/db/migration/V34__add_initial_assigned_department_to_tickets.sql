ALTER TABLE tickets
    ADD COLUMN initial_auto_assigned_department_id BIGINT NULL AFTER assigned_department_id;

UPDATE tickets
SET initial_auto_assigned_department_id = assigned_department_id
WHERE initial_auto_assigned_department_id IS NULL
