...
public class AdminWorkiQuestionController {
	...
	public ResponseEntity<AdminWorkiQuestionDeleteResponse> delete(@PathVariable Long questionId) {
		return ResponseEntity.ok(adminWorkiQuestionService.delete(questionId));
	}
}
