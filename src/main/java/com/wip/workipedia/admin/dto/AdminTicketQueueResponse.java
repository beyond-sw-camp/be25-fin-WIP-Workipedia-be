...
//   keyword_score * 0.25                요청 내용에 들어간 키워드가 특정 부서와 얼마나 잘 맞는지
// + document_similarity_score * 0.30    요청 내용이 기존 매뉴얼/워키 문서와 얼마나 비슷한지
// + category_mapping_score * 0.20       사용자가 선택한 카테고리가 어느 부서와 매핑되어 있는지
// + past_ticket_score * 0.15            과거 비슷한 티켓들이 어느 부서에서 처리됐는지
// + llm_classification_score * 0.10     LLM이 문장을 읽고 어떤 부서가 맞다고 분류했는지