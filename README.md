...
### 문제 정의
현재 인사·온보딩 관련 정보는 메일, 메신저, 사내 게시판, PDF 매뉴얼 등 여러 채널에 분산되어 있어 필요한 정보를 빠르게 찾기 어렵다. 

이로 인해 신규 입사자는 연차, 근태, 복지, 교육, 장비 지급과 같은 기본적인 정보 확인에도 많은 시간을 소모하게 되며, HR 담당자는 동일한 질문에 반복적으로 답변해야 하는 문제가 발생한다.
