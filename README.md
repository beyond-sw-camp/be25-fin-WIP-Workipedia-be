...
적용 기준
• 인용 출처가 포함된 챗봇 답변 1건당 절감 시간은 3분으로 산정했습니다.
• 사용자별 일간 최대 인정 절감 시간은 37.8분으로 제한했습니다.
• 37.8분은 McKinsey 자료의 “직원이 하루 약 1.8시간을 정보 탐색에 사용하며, 지식 공유·검색 개선으로 최대 35% 절감 가능”하다는 기준을 보수적으로 적용한 값입니다.
  ◦ 108분 × 35% = 37.8분
•
PC 평균 소비 전력은 MVP 산정 기준으로 0.08kW를 적용했습니다.
•
전력 배출계수는 0.478kgCO2e/kWh를 적용했습니다.
•
스마트폰 충전 환산은 미국 EPA 기준 1회 충전 = 0.0124kgCO2를 사용했습니다.
참고 근거
•
McKinsey Global Institute, The social economy: Unlocking value and productivity through social technologies
◦
직원의 정보 탐색 시간과 지식 검색 개선에 따른 절감 가능성 산정 근거
•
U.S. EPA, Greenhouse Gas Equivalencies Calculator - Calculations and References
◦
스마트폰 1회 충전당 1.24 × 10^-5 metric tons CO2, 즉 0.0124kgCO2 환산 기준
◦
